...
declare var $: any;
@Component({
  selector: 'app-imprimante-disponible',
  templateUrl: './imprimante-disponible.component.html',
  styleUrls: ['./imprimante-disponible.component.css']
})
export class ImprimanteDisponibleComponent {
    ...
    if(this.deleteImprimante != undefined) {
      ...
      this.imprimanteService.deleteImprimante(this.deleteImprimante!.id).subscribe({
        ...
        next: () => {
                ...
                if(this.deleteImprimante?.codeBarre!=null){
                   let index1 = this.listeImprimanteDisponible.indexOf(this.deleteImprimante!);
                   this.listeImprimanteDisponible.splice(index1, 1);
                 }
        },
